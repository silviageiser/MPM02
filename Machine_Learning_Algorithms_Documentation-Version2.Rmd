...
ggplot(data = data, mapping = aes(y = MillionYes, x = log(Living_space))) + geom_point()
```
...
## Result
```{r, echo=FALSE, fig.cap="ABM_1", out.width = '100%'}
knitr::include_graphics("ABM_1.PNG")
```

```{r, echo=FALSE, fig.cap="ABM_2", out.width = '100%'}
