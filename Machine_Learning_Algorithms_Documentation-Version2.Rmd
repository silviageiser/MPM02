...
```{r}
#exponential function, is needed duelog() function as link function within glm
exp(coef(glm.rooms)) 
...
```{r, include = T}
#to double check single house (type) is checked and predicted
...
```
The results of the simulation seem to agree with the observation, see for example Type = Villa, but there are some difference due to outliers
...
## Result
```{r, echo=FALSE, fig.cap="ABM", out.width = '100%'}
